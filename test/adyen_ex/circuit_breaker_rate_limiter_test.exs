defmodule AdyenEx.CircuitBreakerTest do
  ...
  defp start_breaker(opts \\ []) do
    ...
    {:ok, pid} =
      GenServer.start_link(AdyenEx.CircuitBreaker,
...
defmodule AdyenEx.RateLimiterTest do
  use ExUnit.Case, async: false

  defp start_limiter(rate \\ 100, burst \\ 200) do
    {:ok, pid} =
      GenServer.start_link(AdyenEx.RateLimiter,
        rate: rate,
        burst: burst
      )
