defmodule AdyenEx.Management.PayoutSettingsTest do
  use ExUnit.Case, async: true

  setup do
    bypass = Bypass.open()
    %{bypass: bypass, config: AdyenEx.Config.load!(%{api_key: "test_key"})}
  end
  ...
  test "add/3 POSTs to /merchants/:id/payoutSettings", %{bypass: bypass, config: config} do
    ...
    assert {:ok, %{"id" => "PS_1"}} =
             AdyenEx.Client.post(url, %{enabled: true, transferInstrumentId: "TI_1"},
               config: config
             )
  end
  ...
  test "list/2 GETs /merchants/:id/payoutSettings", %{bypass: bypass, config: config} do
    ...
    url = "http://localhost:#{bypass.port}/v3/merchants/MERCH_1/payoutSettings"
    assert {:ok, %{"data" => []}} = AdyenEx.Client.get(url, config: config)
  end
  ...
  test "get/3 GETs /merchants/:id/payoutSettings/:setting_id", %{bypass: bypass, config: config} do
    ...
    assert {:ok, %{"id" => "PS_1"}} = AdyenEx.Client.get(url, config: config)
  end
  ...
  test "update/4 PATCHes /merchants/:id/payoutSettings/:setting_id", %{
    ...
    assert {:ok, %{"enabled" => false}} =
             AdyenEx.Client.patch(url, %{enabled: false}, config: config)
  end
  ...
  test "delete/3 DELETEs /merchants/:id/payoutSettings/:setting_id", %{
    ...
    url = "http://localhost:#{bypass.port}/v3/merchants/MERCH_1/payoutSettings/PS_1"
    assert {:ok, _} = AdyenEx.Client.delete(url, config: config)
  end
end

defmodule AdyenEx.Management.AllowedOriginsTest do
  use ExUnit.Case, async: true
  ...
  test "get_my_origin/2 GETs /me/allowedOrigins/:id", %{bypass: bypass, config: config} do
    ...
    assert {:ok, %{"id" => "OID_1"}} = AdyenEx.Client.get(url, config: config)
  end
  ...
  test "list_merchant_origins/3 GETs merchant credential origins", %{
    ...
    assert {:ok, _} = AdyenEx.Client.get(url, config: config)
  end
  ...
  test "create_merchant_origin/4 POSTs merchant credential origin", %{
    ...
    assert {:ok, %{"id" => "OID_NEW"}} =
             AdyenEx.Client.post(url, %{domain: "example.com"}, config: config)
  end
...
defmodule AdyenEx.Management.TerminalSettingsLogoTest do
  use ExUnit.Case, async: true
  ...
  test "update_store_logo/4 PATCHes merchant+store_ref logo", %{bypass: bypass, config: config} do
    ...
    url = "http://localhost:#{bypass.port}/v3/merchants/MERCH_1/stores/STORE_1/terminalLogos"
    assert {:ok, _} = AdyenEx.Client.patch(url, %{data: "base64..."}, config: config)
  end
...
defmodule AdyenEx.Management.TerminalManagementTest do
  use ExUnit.Case, async: true
  ...
  for {action, path} <- [
    ...
    test "#{action}/2 POSTs to postfmapi/#{path}", %{bypass: bypass, config: config} do
      ...
      assert {:ok, _} = AdyenEx.Client.post(url, %{companyAccount: "Test"}, config: config)
    end
  end
end

defmodule AdyenEx.RaiseDisputesTest do
  use ExUnit.Case, async: true
  ...
  test "raise_dispute/2 POSTs to /disputes", %{bypass: bypass, config: config} do
    ...
    assert {:ok, %{"id" => "DISP_1"}} =
             AdyenEx.Client.post(url, %{transactionId: "TXN_123", reason: "itemNotReceived"},
               config: config
             )
  end
  ...
  test "get/2 GETs /disputes/:id", %{bypass: bypass, config: config} do
    ...
    assert {:ok, %{"id" => "DISP_1"}} = AdyenEx.Client.get(url, config: config)
  end
  ...
  test "update/3 PATCHes /disputes/:id", %{bypass: bypass, config: config} do
    ...
    assert {:ok, _} =
             AdyenEx.Client.patch(url, %{description: "Updated description"}, config: config)
  end
  ...
  test "add_attachment/3 POSTs to /disputes/:id/attachments", %{bypass: bypass, config: config} do
    ...
    assert {:ok, %{"id" => "ATT_1"}} =
             AdyenEx.Client.post(url, %{content: "base64...", contentType: "image/jpeg"},
               config: config
             )
  end
  ...
  test "get_attachment/3 GETs /disputes/:id/attachments/:att_id", %{
    ...
    assert {:ok, %{"id" => "ATT_1"}} = AdyenEx.Client.get(url, config: config)
  end
...
defmodule AdyenEx.BalancePlatform.ExtrasTest do
  use ExUnit.Case, async: true
  ...
  test "WebhookSettings.create/3 POSTs balance webhook setting", %{bypass: bypass, config: config} do
    ...
    assert {:ok, %{"id" => "BWH_1"}} =
             AdyenEx.Client.post(url, %{url: "https://example.com/hook"}, config: config)
  end
  ...
  test "PaymentInstrumentGroups.create/2 POSTs to /paymentInstrumentGroups", %{
    ...
    assert {:ok, %{"id" => "PIG_1"}} =
             AdyenEx.Client.post(url, %{balancePlatform: "BP_1"}, config: config)
  end
  ...
  test "PaymentInstrumentGroups.get/2 GETs /paymentInstrumentGroups/:id", %{
    ...
    assert {:ok, %{"id" => "PIG_1"}} = AdyenEx.Client.get(url, config: config)
  end
  ...
  test "SCADevices.begin_registration/2 POSTs to /scaDevices", %{bypass: bypass, config: config} do
    ...
    assert {:ok, %{"id" => "SCA_1"}} =
             AdyenEx.Client.post(url, %{paymentInstrumentId: "PI_1"}, config: config)
  end
  ...
  test "SCADevices.finish_registration/3 PATCHes /scaDevices/:id", %{
    ...
    assert {:ok, %{"status" => "registered"}} =
             AdyenEx.Client.patch(url, %{registrationCode: "CODE_123"}, config: config)
  end
  ...
  test "SCADevices.create_association/3 POSTs /scaDevices/:id/associations", %{
    ...
    assert {:ok, _} = AdyenEx.Client.post(url, %{paymentInstrumentId: "PI_1"}, config: config)
  end
  ...
  test "TransferLimits.approve_balance_account_limits/3 POSTs limit approval", %{
    ...
    assert {:ok, _} = AdyenEx.Client.post(url, %{}, config: config)
  end
  ...
  test "TransferLimits.create_platform_limit/3 POSTs platform limit", %{
    ...
    assert {:ok, %{"id" => "LIMIT_1"}} =
             AdyenEx.Client.post(url, %{amount: %{currency: "EUR", value: 10_000}},
               config: config
             )
  end
